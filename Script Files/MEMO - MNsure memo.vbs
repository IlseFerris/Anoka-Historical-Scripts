...
If radiogroup1 = 0 then
  ...
  If waiting_check <> "Waiting" then script_end_procedure("No waiting notice was found. You might be in the wrong footer month. If you still have this problem email Veronica Cary your footer month and case number. Also include a description of what's wrong.")
...
EMSendKey "effective " & denial_effective_date & "." & "<newline>" & "<newline>" & "You may be able to purchase medical insurance through MNsure. If your family is under an income limit you may get financial help to purchase insurance. You can apply online at www.mnsure.org. If you have questions or need help to apply you can call the MNsure Call Center at 1-855-366-7873 or the Anoka County Community Action Program at 763 783-4777."
PF4
PF3
