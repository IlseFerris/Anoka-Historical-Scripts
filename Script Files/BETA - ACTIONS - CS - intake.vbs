'GATHERING STATS----------------------------------------------------------------------------------------------------
name_of_script = "BETA - ACTIONS - CS - intake"
start_time = timer
...
BeginDialog CS_intake_dialog, 0, 0, 371, 345, "CS intake dialog"
  EditBox 65, 5, 85, 15, client_first_name
  EditBox 225, 5, 85, 15, client_last_name
  ...
  EditBox 270, 155, 85, 15, worker_signature
  EditBox 270, 175, 85, 15, worker_phone
  ButtonGroup ButtonPressed
    OkButton 230, 195, 50, 15
    CancelButton 285, 195, 50, 15
  Text 5, 10, 55, 10, "Client first name:"
  Text 165, 10, 55, 10, "Client last name:"
  GroupBox 5, 25, 180, 70, "Address"
  GroupBox 190, 100, 180, 50, "DORD docs to print for client"
  Text 205, 160, 60, 10, "Worker signature:"
  ...
  Text 215, 180, 50, 10, "Worker phone:"
EndDialog
...
If NCP_PRISM_gender = "FAT" then					'If it's "FAT" it's the father, otherwise it's the mother. Adjusting the variable.
	NCP_gender = "father"
Else
	NCP_gender = "mother"
End if
...
End if
CP_name = client_first_name & " " & client_last_name			'CP name
...
If _
	...
	issues_paternity_to_be_decided_check = checked or _
	parenting_time_schedules_check = checked or _
...
'Opening the Issues-Paternity-to be Decided document (does not autofill any info)
If issues_paternity_to_be_decided_check = checked then set objDoc = objWord.Documents.Add("Q:\Blue Zone Scripts\Word documents for script use\Issues-Paternity-to be decided.dotx")

'Opening the Parenting Time Schedules document (does not autofill any info)
If parenting_time_schedules_check = checked then set objDoc = objWord.Documents.Add("Q:\Blue Zone Scripts\Word documents for script use\Parenting Time Schedules.dotx")
