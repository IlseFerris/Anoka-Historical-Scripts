...
'Validating user ID
If user_ID_for_validation <> "RKCARY" and _
   user_ID_for_validation <> "AJURICH" and _
   user_ID_for_validation <> "JMBART" and _
   user_ID_for_validation <> "SLCARDA" and _
   user_ID_for_validation <> "IGFERRIS" and _
   user_ID_for_validation <> "HLMUI" and _
   user_ID_for_validation <> "CMCOX" and _
   user_ID_for_validation <> "CJWOTHE" and _
   user_ID_for_validation <> "JGLETH" and _
   user_ID_for_validation <> "KMDEMARS" and _
   user_ID_for_validation <> "ELSPANIE" _
