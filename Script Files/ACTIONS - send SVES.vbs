...
If MAXIS_check <> "MAXIS" then
  MsgBox "MAXIS is not found on this screen. Navigate to MAXIS and try again."
  StopScript
End if
...
EMReadScreen county, 4, 21, 21 'This will check the county. If this case is not x102, the script will stop.
If county <> "X102" then 
