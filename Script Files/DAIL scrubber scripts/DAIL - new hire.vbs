...
EMSendKey replace(new_hire_first_line, new_HIRE_SSN, "XXX-XX-" & right(new_HIRE_SSN, 4)) & "<newline>" & new_hire_second_line & "<newline>" & new_hire_third_line + "<newline>" & new_hire_fourth_line & "<newline>" & "---" & "<newline>"
