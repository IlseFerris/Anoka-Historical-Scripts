...
If cash_disa_status = 1 then EMSendKey "* Client needs a new Medical Opinion Form. Sent using Compass Forms. TIKLed for 30-day return." + "<newline>"
EMSendKey "---" + "<newline>"
...
MsgBox "Case note and TIKL made. Send a Medical Opinion Form using Compass Forms."
