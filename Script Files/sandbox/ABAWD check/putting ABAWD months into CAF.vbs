...
BeginDialog CAF_dialog_02, 0, 0, 451, 295, "CAF dialog part 2"
  EditBox 60, 45, 385, 15, earned_income
  EditBox 70, 65, 375, 15, unearned_income
  EditBox 85, 85, 185, 15, income_changes
  EditBox 65, 105, 380, 15, notes_on_income
  EditBox 155, 125, 290, 15, is_any_work_temporary
  EditBox 60, 155, 385, 15, SHEL_HEST
  EditBox 60, 175, 250, 15, COEX_DCEX
  EditBox 65, 205, 380, 15, CASH_ACCTs
  EditBox 155, 225, 290, 15, other_assets
  EditBox 55, 255, 390, 15, verifs_needed
  ButtonGroup ButtonPressed
    PushButton 340, 275, 50, 15, "NEXT", next_to_page_03_button
    ...
    PushButton 5, 180, 25, 10, "COEX/", COEX_button
    PushButton 30, 180, 25, 10, "DCEX:", DCEX_button
    PushButton 5, 210, 25, 10, "CASH/", CASH_button
    PushButton 30, 210, 30, 10, "ACCTs:", ACCT_button
    PushButton 5, 230, 25, 10, "CARS/", CARS_button
    PushButton 30, 230, 25, 10, "REST/", REST_button
    PushButton 55, 230, 25, 10, "SECU/", SECU_button
    PushButton 80, 230, 25, 10, "TRAN/", TRAN_button
    PushButton 105, 230, 45, 10, "other assets:", OTHR_button
    PushButton 275, 280, 60, 10, "previous page", previous_to_page_01_button
  ...
  Text 5, 130, 150, 10, "Is any work temporary? If so, explain details:"
...
BeginDialog CAF_dialog_03, 0, 0, 451, 365, "CAF dialog part 3"
  ...
  CheckBox 25, 240, 260, 10, "Check here to CASE/NOTE CL's ABAWD-Counted Months", run_abawd_count_check
  EditBox 55, 260, 230, 15, other_notes
  ComboBox 330, 260, 115, 15, "incomplete"+chr(9)+"complete", CAF_status
  ...
  ButtonGroup ButtonPressed
    ...
    PushButton 270, 345, 60, 10, "previous page", previous_to_page_02_button
  GroupBox 5, 5, 130, 25, "ELIG panels:"
  GroupBox 330, 5, 115, 35, "STAT-based navigation"
...
function how_many_abawd_months(abawd_result)
  ...
  PF3
  abawd_result = "* CL has used " & month_count & " ABAWD-counted months."
END function
...
'Grabs the CL's ABAWD-counted information for the case/note------------------------------------------------------
...
LOOP until month_count = 36
PF3
abawd_result = "* CL has used " & abawd_counted_months & " ABAWD-counted months."
...
IF run_abawd_count_check = 1 THEN call write_new_line_in_case_note(ABAWD_result)
