...
DO
  ...
  Else
    ...
    If MMIS_edit_mode_check <> "'''''" then script_end_procedure("MMIS edit mode not found. Are you in inquiry? Is MMIS not functioning? Shut down this script and try again. If it continues to not work, email Ronny the case number, and a screenshot of MMIS.")
  End if
