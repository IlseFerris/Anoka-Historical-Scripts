  ...
  Elseif panel_read_from = "STWK" then '----------------------------------------------------------------------------------------------------STWK
    For each HH_member in HH_member_array
	  ...
	  EMreadscreen voluntary_quit, 1, 10, 46
        ...
        variable_written_to = variable_written_to & new_STWK_employer & "income stopped " & STWK_income_stop_date & STWK_verification & ".; " & "Vol quit: " & vol_quit
      End if
...
call autofill_editbox_from_MAXIS_test(HH_member_array, "stwk", final_info)
