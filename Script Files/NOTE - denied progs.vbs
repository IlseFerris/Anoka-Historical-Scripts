'STATS GATHERING----------------------------------------------------------------------------------------------------
name_of_script = "NOTE - denied progs"
start_time = timer
...
BeginDialog denied_dialog, 0, 0, 401, 340, "Denied progs dialog"
  ...
  CheckBox 5, 290, 65, 10, "Updated MMIS?", updated_MMIS_check
  CheckBox 80, 290, 155, 10, "Check here if you sent a NOMI to this client.", NOMI_check
  CheckBox 245, 290, 95, 10, "WCOM added to notice?", WCOM_check
  CheckBox 30, 305, 125, 10, "Check here to TIKL to send to CLS.", TIKL_check
  EditBox 75, 320, 70, 15, worker_signature
  ButtonGroup ButtonPressed
    OkButton 265, 320, 50, 15
    CancelButton 320, 320, 50, 15
    PushButton 125, 60, 175, 15, "Autofill previous denied progs script dates/reasons", autofill_previous_info_button
    PushButton 345, 290, 50, 10, "SPEC/WCOM", SPEC_WCOM_button
