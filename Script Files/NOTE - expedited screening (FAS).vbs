...
BeginDialog exp_screening_dialog, 0, 0, 216, 185, "Expedited Screening Dialog"
  ...
  CheckBox 5, 135, 180, 10, "Check here if this appointment is a paper process.", paper_process_check
  CheckBox 5, 150, 195, 10, "Check here to start the appointment letter after this.", appointment_letter_check
  EditBox 125, 165, 80, 15, worker_signature
  ...
  Text 50, 170, 70, 10, "Sign your case note:"
EndDialog
...
If paper_process_check = 1 then EMSendKey "Received PP " & application_type & ", " & expedited_status + "<newline>"
If paper_process_check = 0 then EMSendKey "Received " & application_type & ", " & expedited_status + "<newline>"
EMSendKey "---" + "<newline>"
...
'If appointment letter is checked then it will start that script.
If appointment_letter_check = 1 then run_another_script("Q:\Blue Zone Scripts\Script Files\MEMO - appt letter.vbs")
