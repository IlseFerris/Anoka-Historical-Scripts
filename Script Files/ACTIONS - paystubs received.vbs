...
If datediff("d", "06/24/2013", now) < 7 then MsgBox "This script has been updated as of 06/24/2013! It will now case note which HH member had the paystubs (if not 01). It also now provides an option to case note even when not updating the PIC. Try it out and let me know what you think! -Ronny"
