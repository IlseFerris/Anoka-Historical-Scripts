...
EMReadScreen cola_month_check, 5, 20, 55
If cola_month_check <> "01 12" then stopscript
...
strFileName = "h:\COLA worklist for MAXIS script - " & worker_number & ".xlsx"  
Set objWorkbook = objExcel.Workbooks.Add() 
ObjExcel.Cells(1, 1).Value = "M# with FS"
ObjExcel.Cells(1, 4).Value = "FS with SS that was COLA updated"
ObjExcel.Cells(1, 6).Value = "FS with SS that was not COLA updated"
...
'Now it checks UNEA to determine if there is any RSDI/SSI. It starts with memb 01. If there are additional members it adds them in.
  Do
    ...
    Do
      ...
      EMReadScreen prospective_income_amount, 8, 14, 68
      EMReadScreen prospective_income_month, 2, 14, 54
      EMReadScreen prospective_income_year, 2, 14, 60
      If (prospective_income_month <> "01" and prospective_income_year <> "12") and (income_type = "01" or income_type = "02" or income_type = "03") then case_has_SS_and_COLA_updated = "False"
      If (prospective_income_month = "01" and prospective_income_year = "12") and (income_type = "01" or income_type = "02" or income_type = "03") and case_has_SS_and_COLA_updated <> "False" then case_has_SS_and_COLA_updated = "True"
      If (prospective_income_month = "01" and prospective_income_year = "12") and (income_type = "01" or income_type = "02" or income_type = "03") then EMSendKey "<PF9>"
      If (prospective_income_month = "01" and prospective_income_year = "12") and (income_type = "01" or income_type = "02" or income_type = "03") then EMWaitReady 1, 1
      If (prospective_income_month = "01" and prospective_income_year = "12") and (income_type = "01" or income_type = "02" or income_type = "03") then EMSetCursor 11, 26
      If (prospective_income_month = "01" and prospective_income_year = "12") and (income_type = "01" or income_type = "02" or income_type = "03") then EMSendKey "x" + "<enter>"
      If (prospective_income_month = "01" and prospective_income_year = "12") and (income_type = "01" or income_type = "02" or income_type = "03") then EMWaitReady 1, 1
      If (prospective_income_month = "01" and prospective_income_year = "12") and (income_type = "01" or income_type = "02" or income_type = "03") then EMSendKey "121311"
      If (prospective_income_month = "01" and prospective_income_year = "12") and (income_type = "01" or income_type = "02" or income_type = "03") then EMReadScreen PIC_amount, 8, 8, 66
      If (prospective_income_month = "01" and prospective_income_year = "12") and (income_type = "01" or income_type = "02" or income_type = "03") and PIC_amount = "________" then PIC_amount = 1 'This sets the PIC amount to be updated if actual income was used in the determination.
      If (prospective_income_month = "01" and prospective_income_year = "12") and (income_type = "01" or income_type = "02" or income_type = "03") and PIC_amount < prospective_income_amount then EMWriteScreen prospective_income_amount, 8, 66
      If (prospective_income_month = "01" and prospective_income_year = "12") and (income_type = "01" or income_type = "02" or income_type = "03") and PIC_amount < prospective_income_amount then EMSetCursor 9, 13    
      If (prospective_income_month = "01" and prospective_income_year = "12") and (income_type = "01" or income_type = "02" or income_type = "03") and PIC_amount < prospective_income_amount then EMSendKey "              "
      If (prospective_income_month = "01" and prospective_income_year = "12") and (income_type = "01" or income_type = "02" or income_type = "03") and PIC_amount < prospective_income_amount then EMSetCursor 10, 13
      If (prospective_income_month = "01" and prospective_income_year = "12") and (income_type = "01" or income_type = "02" or income_type = "03") and PIC_amount < prospective_income_amount then EMSendKey "              "
      If (prospective_income_month = "01" and prospective_income_year = "12") and (income_type = "01" or income_type = "02" or income_type = "03") and PIC_amount < prospective_income_amount then EMSetCursor 11, 13
      If (prospective_income_month = "01" and prospective_income_year = "12") and (income_type = "01" or income_type = "02" or income_type = "03") and PIC_amount < prospective_income_amount then EMSendKey "              "
      If (prospective_income_month = "01" and prospective_income_year = "12") and (income_type = "01" or income_type = "02" or income_type = "03") and PIC_amount < prospective_income_amount then EMSetCursor 12, 13
      If (prospective_income_month = "01" and prospective_income_year = "12") and (income_type = "01" or income_type = "02" or income_type = "03") and PIC_amount < prospective_income_amount then EMSendKey "              "
      If (prospective_income_month = "01" and prospective_income_year = "12") and (income_type = "01" or income_type = "02" or income_type = "03") and PIC_amount < prospective_income_amount then EMSetCursor 13, 13
      If (prospective_income_month = "01" and prospective_income_year = "12") and (income_type = "01" or income_type = "02" or income_type = "03") and PIC_amount < prospective_income_amount then EMSendKey "              "
      If (prospective_income_month = "01" and prospective_income_year = "12") and (income_type = "01" or income_type = "02" or income_type = "03") then EMSendKey "<enter>"
      If (prospective_income_month = "01" and prospective_income_year = "12") and (income_type = "01" or income_type = "02" or income_type = "03") then EMWaitReady 1, 1
      If (prospective_income_month = "01" and prospective_income_year = "12") and (income_type = "01" or income_type = "02" or income_type = "03") then EMSendKey "<enter>"
      If (prospective_income_month = "01" and prospective_income_year = "12") and (income_type = "01" or income_type = "02" or income_type = "03") then EMWaitReady 1, 1
      If (prospective_income_month = "01" and prospective_income_year = "12") and (income_type = "01" or income_type = "02" or income_type = "03") then EMSendKey "<enter>"
  ...
  Do
    ...
    Do
      ...
      If case_has_SS_and_COLA_updated = "True" and JOBS_total <> "0" then case_has_JOBS = "True"
      If case_has_SS_and_COLA_updated = "True" and JOBS_total <> "0" then EMSendKey "<PF9>"
      If case_has_SS_and_COLA_updated = "True" and JOBS_total <> "0" then EMReadScreen prospective_date_first_line, 2, 12, 54
      If case_has_SS_and_COLA_updated = "True" and JOBS_total <> "0" and prospective_date_first_line <> "__" then EMWriteScreen "01", 12, 54
      If case_has_SS_and_COLA_updated = "True" and JOBS_total <> "0" and prospective_date_first_line <> "__" then EMWriteScreen "12", 12, 60
      If case_has_SS_and_COLA_updated = "True" and JOBS_total <> "0" then EMReadScreen prospective_date_second_line, 2, 13, 54
      If case_has_SS_and_COLA_updated = "True" and JOBS_total <> "0" and prospective_date_second_line <> "__" then EMWriteScreen "01", 13, 54
      If case_has_SS_and_COLA_updated = "True" and JOBS_total <> "0" and prospective_date_second_line <> "__" then EMWriteScreen "12", 13, 60
      If case_has_SS_and_COLA_updated = "True" and JOBS_total <> "0" then EMReadScreen prospective_date_third_line, 2, 14, 54
      If case_has_SS_and_COLA_updated = "True" and JOBS_total <> "0" and prospective_date_third_line <> "__" then EMWriteScreen "01", 14, 54
      If case_has_SS_and_COLA_updated = "True" and JOBS_total <> "0" and prospective_date_third_line <> "__" then EMWriteScreen "12", 14, 60
      If case_has_SS_and_COLA_updated = "True" and JOBS_total <> "0" then EMReadScreen prospective_date_fourth_line, 2, 15, 54
      If case_has_SS_and_COLA_updated = "True" and JOBS_total <> "0" and prospective_date_fourth_line <> "__" then EMWriteScreen "01", 15, 54
      If case_has_SS_and_COLA_updated = "True" and JOBS_total <> "0" and prospective_date_fourth_line <> "__" then EMWriteScreen "12", 15, 60
      If case_has_SS_and_COLA_updated = "True" and JOBS_total <> "0" then EMReadScreen prospective_date_fifth_line, 2, 16, 54
      If case_has_SS_and_COLA_updated = "True" and JOBS_total <> "0" and prospective_date_fifth_line <> "__" then EMWriteScreen "01", 16, 54
      If case_has_SS_and_COLA_updated = "True" and JOBS_total <> "0" and prospective_date_fifth_line <> "__" then EMWriteScreen "12", 16, 60
      If case_has_SS_and_COLA_updated = "True" and JOBS_total <> "0" then EMSetCursor 12, 25
      If case_has_SS_and_COLA_updated = "True" and JOBS_total <> "0" then EMSendKey "              "
      If case_has_SS_and_COLA_updated = "True" and JOBS_total <> "0" then EMSetCursor 13, 25
      If case_has_SS_and_COLA_updated = "True" and JOBS_total <> "0" then EMSendKey "              "
      If case_has_SS_and_COLA_updated = "True" and JOBS_total <> "0" then EMSetCursor 14, 25
      If case_has_SS_and_COLA_updated = "True" and JOBS_total <> "0" then EMSendKey "              "
      If case_has_SS_and_COLA_updated = "True" and JOBS_total <> "0" then EMSetCursor 15, 25
      If case_has_SS_and_COLA_updated = "True" and JOBS_total <> "0" then EMSendKey "              "
      If case_has_SS_and_COLA_updated = "True" and JOBS_total <> "0" then EMSetCursor 16, 25
      If case_has_SS_and_COLA_updated = "True" and JOBS_total <> "0" then EMSendKey "              "
      If case_has_SS_and_COLA_updated = "True" and JOBS_total <> "0" then EMSetCursor 18, 43
      If case_has_SS_and_COLA_updated = "True" and JOBS_total <> "0" then EMSendKey "   "
      If case_has_SS_and_COLA_updated = "True" and JOBS_total <> "0" then EMReadScreen prospective_JOBS_question_mark_check, 1, 18, 72
      If case_has_SS_and_COLA_updated = "True" and JOBS_total <> "0" and prospective_JOBS_question_mark_check = "?" then EMWriteScreen "0", 18, 72
      If case_has_SS_and_COLA_updated = "True" and JOBS_total <> "0" then EMSendKey "<enter>"
      If case_has_SS_and_COLA_updated = "True" and JOBS_total <> "0" then EMWaitReady 1, 1
      EMSendKey "<enter>"
      EMWaitReady 1, 1
  ...
  If case_has_SS_and_COLA_updated = "True" then ObjExcel.Cells(excel_row_variable_col_4, 4).Value = case_number
  If case_has_SS_and_COLA_updated = "True" then excel_row_variable_col_4 = excel_row_variable_col_4 + 1

  If case_has_SS_and_COLA_updated = "False" then ObjExcel.Cells(excel_row_variable_col_6, 6).Value = case_number
  If case_has_SS_and_COLA_updated = "False" then excel_row_variable_col_6 = excel_row_variable_col_6 + 1

  case_has_SS_and_COLA_updated = empty 'resetting the variable before the next instance of the do...loop runs
  case_has_JOBS = empty 'resetting the variable before the next instance of the do...loop runs
