amt_of_times_to_run = 11
'amt_of_times_to_run = 2

kids_to_add = array("03")

ABPS_action = "nn"
ABPS_last_name = "Surlington"
ABPS_first_name = "Garth"
ABPS_gender = "M"
...
EATS_action = "nn" 'If creating a new one, this should be "nn", in lower case, otherwise, it should be the panel to edit. Blank out if not used
PP_together = "Y"
...
HEST_action = "nn" 'If creating a new one, this should be "nn", in lower case, otherwise, it should be the panel to edit. Blank it out if not used ("").
