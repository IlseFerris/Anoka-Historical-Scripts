...
UNEA_member = "03"
UNEA_action = "01" 'If creating a new one, this should be "nn", in lower case, otherwise, it should be the panel to edit.
UNEA_type = "03"
UNEA_claim_number = "474470840DI"
...
update_HC_income_estimator = True
