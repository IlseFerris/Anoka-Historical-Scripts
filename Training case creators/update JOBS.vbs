amt_of_times_to_run = 4 'Max is 12
JOBS_member = "01"
JOBS_location = "The workplace"
JOBS_action = "nn" 'If creating a new one, this should be "nn", in lower case, otherwise, it should be the panel to edit.
