...
UNEA_start_date_year = "10"
pay_freq = 4 '1 for monthly, 2 for semi-monthly, 3 for biweekly and 4 for weekly.
pay_amount = 100
update_PIC = True 'Not programmed yet, need to block out a line and enter PIC manually each time.
