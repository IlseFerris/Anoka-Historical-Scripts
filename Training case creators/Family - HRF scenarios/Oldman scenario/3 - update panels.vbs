...
EMPS_action = "nn" 'Blank this out to skip. If updating an existing panel, put "01".
...
SHEL_action = "nn" 'If creating a new one, this should be "nn", in lower case, otherwise, it should be the panel to edit. Blank it out if not used ("").
SHEL_member = "01"
...
JOBS_member = "01"
JOBS_location = "Walmart"
JOBS_start_date_month = "12"
JOBS_start_date_day = "10"
JOBS_start_date_year = "12"
JOBS_proof = "1"
pay_freq = 4 '1 for monthly, 2 for semi-monthly, 3 for biweekly and 4 for weekly. Biweekly is buggy on hours.
pay_amount = 100
hours_per_check = 10
...
MEMI_action = "01" 'MEMI is always "01", never "NN". Leave blank to skip this one.
MEMI_member = "01"
