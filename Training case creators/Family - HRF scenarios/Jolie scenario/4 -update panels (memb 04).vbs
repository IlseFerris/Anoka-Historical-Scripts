...
kids_to_add = array("03", "04")

ABPS_action = ""
ABPS_last_name = "Someguy"
ABPS_first_name = "Papadad"
ABPS_gender = "M"

PARE_action = ""
both_parents_in_HH = False
stepparent_in_HH = False
PARE_actual_date_MMDDYYYY = "10312013"
...
EMPS_action = "" 'Blank this out to skip. If updating an existing panel, put "01".
EMPS_member_array = array("01")
fin_orient_dt_month = "11"
fin_orient_dt_day = "10"
fin_orient_dt_year = "13"
Mbr_Required_At_Home_For_Special_Medical_Criteria = "N"
Mbr_Required_Home_Care_Ill_Incap_Family_Mbr = "N"
Member_Experiencing_Personal_Family_Crisis = "N"
Member_Meets_Hard_To_Employ_Category = "NO"
full_time_care_of_child_under_1 = "N"
full_time_care_of_child_under_12_weeks = "N" '<<NOT CURRENTLY WRITTEN
EMPS_Exemption_Care_Of_A_Child_Under_One_month = ""
EMPS_Exemption_Care_Of_A_Child_Under_One_year = ""

SCHL_action = "nn"
SCHL_member = "04"
school_status = "F"
school_verification = "SC"
school_type = "02"
district_nbr = "0011"
primary_secondary_funding = "2"
...
JOBS_action = "nn" 'If creating a new one, this should be "nn", in lower case, otherwise, it should be the panel to edit. Blank it out if not used ("").
JOBS_member = "04"
JOBS_location = "Target"
JOBS_start_date_month = "12"
JOBS_start_date_day = "10"
JOBS_start_date_year = "12"
JOBS_proof = "1"
...
ACCT_member = "04"
ACCT_type = "SV"
ACCT_number = "123456789013"
ACCT_location = "Affinity"
ACCT_balance = "900"
ACCT_as_of_month = "12"
ACCT_as_of_day = "01"
ACCT_as_of_year = "12"
...
WREG_action = "" 'If creating a new one, this should be "nn", in lower case, otherwise, it should be the panel to edit. Leave blank to ignore this panel.
WREG_member_array = array("01") 
FSET_status = "08"
defer_FSET_indicator = "_" 'Should usually be a "N" or a "_" for exempt people.
ABAWD_status = "01"
GA_basis = ""

MEMI_action = "" 'MEMI is always "01", never "NN". Leave blank to skip this one.
MEMI_member = "01"
fam_vio_waiver_beg_dt_month = "10"
fam_vio_waiver_beg_dt_year = "13"

CARS_action = "" 'If creating a new one, this should be "nn", in lower case, otherwise, it should be the panel to edit. Leave blank to skip.
CARS_member = "01"
CARS_type = "1" '1 for Car, 2 for truck, 3 for van, 4 for camper, 5 for motorcycle, 6 for trailer, 7 for other
CARS_year = "1999"
CARS_make = "Chevrolet"
CARS_model = "Silverado"
CARS_value = "1000"
...
Do
  ...
  If PARE_action <> "" then 'Updating PARE----------------------------------------------------------------------------------------------------
    ...
    EMSetCursor 5, 37
    EMSendKey PARE_actual_date_MMDDYYYY
  ...
  If EMPS_action <> "" then 'Updating EMPS----------------------------------------------------------------------------------------------------
    For each EMPS_member in EMPS_member_array
      EMWriteScreen "EMPS", 20, 71
      EMWriteScreen EMPS_member, 20, 76
      ...
      EMWriteScreen Mbr_Required_At_Home_For_Special_Medical_Criteria, 8, 76
      EMWriteScreen Mbr_Required_Home_Care_Ill_Incap_Family_Mbr, 9, 76
      EMWriteScreen Member_Experiencing_Personal_Family_Crisis, 10, 76
      EMWriteScreen Member_Meets_Hard_To_Employ_Category, 11, 76
      EMWriteScreen full_time_care_of_child_under_1, 12, 76
      EMWriteScreen full_time_care_of_child_under_12_weeks, 13, 76
  ...
  If SCHL_action <> "" then 'Updating SCHL----------------------------------------------------------------------------------------------------
      EMWriteScreen "schl", 20, 71
      EMWriteScreen SCHL_member, 20, 76
      EMWriteScreen SCHL_action, 20, 79
      EMSendKey "<enter>"
      EMWaitReady 0, 0
    
      If SCHL_action <> "nn" then
        EMSendKey "<PF9>"
        EMWaitReady 0, 0
      End if

      EMWriteScreen school_status, 6, 40
      EMWriteScreen school_verification, 6, 63 
      EMWriteScreen school_type, 7, 40 
      EMWriteScreen district_nbr, 8, 40
      EMWriteScreen primary_secondary_funding, 14, 63
  End if
  ...
  If SHEL_action <> "" then 'Updating SHEL----------------------------------------------------------------------------------------------------
    ...
    EMWriteScreen rent_amt, 11, 37
    EMWriteScreen rent_proof, 11, 48
    EMWriteScreen lot_rent_amt, 12, 37
    EMWriteScreen lot_rent_proof, 12, 48
    EMWriteScreen mortgage_amt, 13, 37
    EMWriteScreen mortgage_proof, 13, 48
    EMWriteScreen insurance_amt, 14, 37
    EMWriteScreen insurance_proof, 14, 48
    EMWriteScreen taxes_amt, 15, 37
    EMWriteScreen taxes_proof, 15, 48
    EMWriteScreen room_amt, 16, 37
    EMWriteScreen room_proof, 16, 48
    EMWriteScreen garage_amt, 17, 37
    EMWriteScreen garage_proof, 17, 48
    EMWriteScreen subsidy_amt, 18, 37
    EMWriteScreen subsidy_proof, 18, 48
  ...
  If MEMI_action <> "" then 'Updating MEMI for Family Violence Waiver Beg Date----------------------------------------------------------------------------------------------------
    EMWriteScreen "MEMI", 20, 71
    EMWriteScreen MEMI_member, 20, 76
    EMWriteScreen MEMI_action, 20, 79
    EMSendKey "<enter>"
    EMWaitReady 0, 0
    ...
    EMWriteScreen fam_vio_waiver_beg_dt_month, 18, 49
    EMWriteScreen fam_vio_waiver_beg_dt_year, 18, 55
