...
ABPS_last_name = "Pendingguy"
ABPS_first_name = "Svetlana"
ABPS_gender = "F"
...
EMPS_action = "nn" 'at this time it just puts "n" for the other stuff. Blank this out to skip. If updating an existing panel, put "01".
