...
'x102_array = array("4BL", "268", "B93", "932", "989", "949", "B64", "BED", "628", "769", "524", "4DK", "750", "4SZ", "950", "742", "4SW", "TRP", "619", "4AS", "894", "987", "4SY", "C08", "624", "200", "616", "4F9", "925", "4BM", "294", "B55", "B48", "A75", "4BV", "B36", "RLM", "B52", "707", "A84", "674", "106", "231", "A18", "733", "962", "213", "A44", "902", "223", "944", "234", "B50", "B97", "618", "225", "C06", "C04", "869", "4SL", "TLP", "C07", "C05", "4ES", "895", "4SX", "978", "222", 
x102_array = array("107", "767", "722", "247", "4AF", "119", "233", "112", "111", "122", "125", "110", "B20", "872", "117", "643", "967", "630", "518", "118", "4RJ", "601", "116", "928", "120", "113", "114", "797", "121", "123", "124", "126", "282", "127")
'x102_array = array("293")
...
ObjExcel.Cells(1, 4).Value = "MEMBs with DISA"
ObjExcel.Cells(1, 5).Value = "MEMBs < 18 or > 49"
ObjExcel.Cells(1, 6).Value = "Sup name"
    ...
    Do
      ...
      Do
        ...
        If FS_status_code = "A" then
          ...
          ObjExcel.Cells(excel_row_variable_col_1, 6).Value = supervisor_name
...
Do
  ...
  HH_memb_row = 5 'Setting up variable for the following do...loop. 
  Do
    EMReadScreen DISA_status, 1, 12, 69
    If DISA_status <> "_" and DISA_status <> "N" then
      EMReadScreen HH_ref_nbr, 2, 4, 33
      ObjExcel.Cells(excel_row_variable_col_1, 4).Value = ObjExcel.Cells(excel_row_variable_col_1, 4).Value & HH_ref_nbr & ", "
    End if
    HH_memb_row = HH_memb_row + 1
    EMReadScreen next_HH_memb, 2, HH_memb_row, 3
    If next_HH_memb <> "  " then
  ...
  Do
    ...
    If MEMB_age = "   " then 
      MEMB_age = 0
    Else
      MEMB_age = cint(MEMB_age)
    End if
    If MEMB_age < 18 or MEMB_age > 49 then
      EMReadScreen HH_ref_nbr, 2, 4, 33
      ObjExcel.Cells(excel_row_variable_col_1, 5).Value = ObjExcel.Cells(excel_row_variable_col_1, 5).Value & HH_ref_nbr & ", "
    End if
    HH_memb_row = HH_memb_row + 1
    EMReadScreen next_HH_memb, 2, HH_memb_row, 3
    If next_HH_memb <> "  " then
