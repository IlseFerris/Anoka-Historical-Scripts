  ...
  If PND2_amt_check <> "0 Of 0" then 'skips workers with no pending cases
    Do
      ...
      Do
        ...
        If (FS_status_code <> "_" or HC_status_code = "P") and FS_status_code <> " " then
      ...
      If last_page_check = "FMAREAM1 0029 NAT1011" then 
        msgbox "error found on worker " & x102_number
        stopscript
      End if
